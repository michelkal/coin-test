								...
								<div class="latest-posts-widget widget widget__footer">
									...
									<div class="widget-content">
										<ul class="latest-posts-list">
											<li>
												<figure class="thumbnail"><a href="#"><img src="{{ URL::asset('images/samples/post-img1-sm.jpg') }}" alt=""></a></figure>
												<h5 class="title"><a href="#">Three Simple Household Repairs That'll Save You Hundreds</a></h5>
												<span class="date">April, 18 2015</span>
											</li>
											<li>
												<figure class="thumbnail"><a href="#"><img src="{{ URL::asset('images/samples/post-img2-sm.jpg') }}" alt=""></a></figure>
												<h5 class="title"><a href="#">Tools That Make Yard Work Easy: The Big Backpack Blower</a></h5>
												<span class="date">March, 21 2015</span>
											</li>
											<li>
												<figure class="thumbnail"><a href="#"><img src="{{ URL::asset('images/samples/post-img3-sm.jpg') }}" alt=""></a></figure>
